...
var client = new Twitter({
    consumer_key: "3hWbGGSzreRtBCKhUNi4yweiz",
    consumer_secret: "GKSOqI1M57uqaMi67ptPpGGVKegPAJusjg2FcLLHMynR5E9mF5",
    access_token_key: "818642221645832193-PfCL2WUwdnnvReBCnre110i2XoCWqJa",
    access_token_secret: "p3TX96rr3ZfzH25DAh459iEEVvrx0YnSE3XQ83QDTRYda"
});
// make a new tweet
function newTweet(coinData) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, client.post("statuses/update", {
                        status: "New Coingecko Listing!\n" +
...
// setInterval(function () { scrape(); }, 1800000);
scrape();
